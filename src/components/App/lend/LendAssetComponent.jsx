      ...
      <div className='page-header flex-1 flex flex-col'>
        ...
        <div className='sort-bar row '>
          <div className='row-headers bg-black h-14 flex items-center justify-between'>
            ...
            <div className='name sortable w-1/6'>
              <span>Name</span>
              {/* <svg
                width='7'
                height='7'
            ...
            <div className='project sortable  w-1/6'>
              <span>Project</span>
              {/* <svg
                width='7'
                height='7'
            ...
            <div className='owner sortable  w-1/6'>
              <span>Owner</span>
              {/* <svg
                width='7'
                height='7'
            ...
            <div className='terms  w-1/6'>
              <span>Terms</span>
            </div>
            <div className='status  w-1/6'>Status</div>
              ...
              {searchResults.map((res, index) => {
                return (
                  <Link
                    ...
                    to='/app/assets/0xe785e82358879f061bc3dcac6f0444462d4b5330/3875'
                  >
                    <div className='w-[8%] inline-block '>
                      <img
                        className='w-8 h-8'
                        src='https://lh3.googleusercontent.com/wZi4YkS6TFfVrxDOp9NBik7RPKH9ffM2eLmsA4kU4P5uR8lHTOK8_0Mbdt75IvxczWMf3-fT1yulr3zQNGJE4H5B_MOVENcgDb8D4vc'
                        alt='WoW #3875'
                      />
                    </div>
                    <div className='name w-1/6 '>WoW #3875</div>
                    <div className='project  w-1/6 '>World Of Women</div>
                    <div className='owner  w-1/6 '>...0f2bf6</div>
                    <div className='terms  w-1/6 '>2 wETH / 45 days</div>
                    <div className='status  w-1/6 '>
                      <div>listed</div>
                    </div>
                    <a
